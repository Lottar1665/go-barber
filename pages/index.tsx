  ...
  return (
    ...
    <Image src={ImageLogo} alt={''} className='w-[230px] h-[134px] md:w-64 md:h-64' />
      ...
      <RiLockPasswordFill className='w-[20] h-[20] bg-input text-icon ml-[16px] mr-[16px]'/>
        <input type="password" placeholder='Digite sua senha' className='w-80 h-14 rounded-xl bg-input border border-bg-enter placeholder-bg-enter focus-within:outline-none focus-within:ring-bg-enter focus-within:ring-1'/>
